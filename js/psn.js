...
const config = {
    serverInfo: {
        ...
        serverIp: "psn.createminecraft.dpdns.org", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
